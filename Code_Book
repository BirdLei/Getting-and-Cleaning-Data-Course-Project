...
the result of which is a 10299x561 data frame, as in the original description
 ("Number of Instances: 10299" and "Number of Attributes: 561"), train/subject_train.txt with test/subject_test.txt,
the result of which is a 10299x1 data frame with subject IDs, and train/y_train.txt with test/y_test.txt, 
...
The result is saved as merged_tidy.txt, a 10299x68 data frame such that the first column contains subject IDs, 
...
The result is saved as merged_tidy_with_averages.txt, a 180x68 data frame, where as before, the first column contains subject IDs, 
